...
// Préparation de la requête SQL pour sélectionner toutes les lignes de la table "menus" où le champ "jour" est égal à "mercredi"
$query = $bdd->prepare("SELECT * FROM menus WHERE jour = 'mercredi'");
